...
public class MarcaController {
	...
	// Recibe como parámetro el id de la marca. El value del RequestMapping indica
	// desde que url se solicita el método
	...
	@RequestMapping(value = { "agregar", "modificar/{id}" }, method = RequestMethod.GET)
	public String marcaform(@PathVariable("id") int id, ModelMap modelMap) {

		if (0 != id) {
			/* Ver cómo pasar los valores. Buscar por id y enviar el objeto posible
			 * solución. Alterar el formulario para que pueda trabajar con las dos opciones,
			 * modificar (con objet) y agregar (default)
			 * */
			
			
			modelMap.put("titulo", "Modificar Marca");
		} else {
	...
	// Agrega la marca cargada en el formulario y redirige a la página con la lista
	// de marcas
